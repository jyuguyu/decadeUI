app.import(function(lib, game, ui, get, ai, _status, app) {
	lib.arenaReady.push(function() {
		...
		if (lib.config["extension_十周年UI_rightLayout"] == "on") {
			head.style.cssText =
				"display: block;--w: 88px;--h: calc(var(--w) * 81/247);width: var(--w);height: var(--h);position: absolute;top: calc(100% - 34px);left: calc(100% - 380px);background-color: transparent;z-index:2";
		} else {
			head.style.cssText =
