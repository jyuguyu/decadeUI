			...
			playerIntro: function(e) {
				...
				container.show = function(player) {
					...
					zbdialog.onclick = function() {
						...
						caizhu.onclick = function() {
							...
							nameshutiao.
							setBackgroundImage('extension/十周年UI/shoushaUI/character/images/' +
								rarity + '.png');

							var useless2 = ui.create.div('.useless2', bigdialog);
							useless2.setBackgroundImage(
								"extension/十周年UI/shoushaUI/character/images/InfoBg2.png");
							//皮肤框
							var pifuk = ui.create.div('.pifuk', bigdialog);
							pifuk.setBackgroundImage(
								"extension/十周年UI/shoushaUI/character/images/pifuk.png");
							var shutiao2 = ui.create.div('.shutiao2', bigdialog);
							shutiao2.setBackgroundImage(
								"extension/十周年UI/shoushaUI/character/images/shutiao.png");
							/*新增势力*/
							...
							*/
							...
							var wanjiaming = ui.create.div('.wanjiaming', bigdialog, player === game
								.me ? lib.config.connect_nickname : get.translation(innerText =
									num = ["氪金抽66", "卡宝真可爱", "蒸蒸日上", "√卡视我如父", "麒麟弓免疫枸杞",
										"坏可宣（老坏批）", "六千大败而归",
										"开局酒古锭", "遇事不决刷个乐", "见面两刀喜相逢", "改名出66", "时代的六万五", "韩旭",
										"司马长衫", "ogx",
										"狗卡不如无名杀", "王八万", "一拳兀突骨", "开局送神将", "丈八二桃", "装甲车车",
										"等我喝口酒", "Samuri", "马",
										"Log-Frunki", "aoe银钱豹", "没有丈八就托管", "无中yyds",
										"给咸鱼鸽鸽打call", "小零二哟～", "长歌最帅了",
										"大猫有侠者之风", "布灵布灵❤️", "我爱～摸鱼🐠～", "小寻寻真棒", "呲牙哥超爱笑",
										"是俺杀哒", "阿七阿七",
										"祖安·灰晖是龙王", "吃颗桃桃好遗计", "好可宣✓良民", "藏海表锅好", "金乎？木乎？水乎！！",
										"无法也无天", "西风不识相",
										"神秘喵酱", "星城在干嘛？", "子鱼今天摸鱼了吗？", "阳光苞里有阳光", "诗笺的小裙裙",
										"轮回中的消逝", "乱踢jb的云野",
										"小一是不是...是不是...", "美羊羊爱瑟瑟", "化梦的星辰", "杰哥带你登dua郎",
										"世中君子人", "叹年华未央", "短咕咕",
										"洛天依？！", "黄老板是好人～", "来点瑟瑟文和", "鲨鱼配辣椒", "萝卜～好萝卜", "废城君",
										"E佬细节鬼才",
										"感到棘手要怀念谁？", "半价小薯片", "JK欧拉欧拉欧拉", "新年快乐", "乔姐带你飞",
										"12345678？", "缘之空",
										"小小恐龙", "教主：杀我！", "才思泉涌的司马", "我是好人", "喜怒无常的大宝", "黄赌毒",
										"阴间杀～秋",
										"敢于劈瓜的关羽", "萌新陆逊", "猫猫虫", "芽衣姐，我不想死---", "暮暮子"
									].randomGet(1)));
              ...
              `;
							...
							vipimg.setBackgroundImage(
								'extension/十周年UI/shoushaUI/character/images/vip/' + viptuji
								.randomGet() + '.png');
							...
							*/
							...
							var gonghui = ui.create.div('.gonghui', bigdialog, get.translation(
								innerText = '公会：' + (num = ['武将美化群', '活动武将群', '萌新代码群',
									...
									'Ciallo～(∠・ω< )⌒★', '美图交流群', '无名杀十周年样式', '无名杀主题样式',
									'💎备用💎', '无名杀琉璃版', '点草施法小鱼'
								]).randomGet(1)));
              ...
              `;
							...
							gonghuiimg.setBackgroundImage(
								'extension/十周年UI/shoushaUI/character/images/gonghui/' +
							...
							var jiangling = ui.create.div('.jiangling', bigdialog, get.translation(
								innerText = (num = Math.floor(Math.random() * (99 - 1 + 1) +
									10)) + '<br>' + '将灵'));
							...
							var chenghaotu = ['不世之功', '等阶至尊', '斗地主之王', '高山流水', '冠秀绝代', '国战霸主',
								'赫赫战功', '唤灵魁首', '君子之交', '祈愿之星', '契合金兰', '身份霸主', '试道勇者', '统率霸主',
								'突破·帝皇境十变', '突破·轮回境三变', '突破·涅槃境五变', '突破·神王境九变', '突破·生死境四变',
								'突破·虚神境七变', '突破·玄幽境一变', '突破·真仙境八变', '万千宠爱', '万砂归宗', '唯我独尊·证道王者',
								'臻玉鎏金', '志同道合', '总角之好',
							];
							minichenghao.setBackgroundImage(
								'extension/十周年UI/shoushaUI/character/images/chenghao/' +
								chenghaotu.randomGet() + '.png');
							/*拜师*/
							var baishi = ui.create.div('.baishi', bigdialog);
							var baishitu = ['b1', 'b2', 'b3', ];
							baishi.setBackgroundImage(
								'extension/十周年UI/shoushaUI/character/images/baishi/' + baishitu
								.randomGet() + '.png');
							/*历史最高*/
							var wngs = ui.create.div('.wngs', bigdialog);
							var wngstu = ['s1', 's2', 's3', 's4', 's5', 's6', ];
							wngs.setBackgroundImage(
								'extension/十周年UI/shoushaUI/character/images/wngs/' + wngstu
								.randomGet() + '.png'); /*将灯*/
							var deng = ui.create.div('.deng', bigdialog);
							var dengto = ['d1', 'd2', 'd3', 'd4', 'd5', 'd6', 'd7', ];
							deng.setBackgroundImage(
								'extension/十周年UI/shoushaUI/character/images/deng/' + dengto
								.randomGet() + '.png');
							/*关闭*/
							...
							minixingxiang.setBackgroundImage(
								'extension/十周年UI/shoushaUI/character/images/' + xingxiangtu
								.randomGet() + '.png');
					...
					if (group != 'wei' && group != 'shu' && group != 'wu' && group != 'qun' &&
						...
						'shen' && group != 'key' && group != 'Han' && group != 'qin')
						group = 'default';
					...
					longkuang.setBackgroundImage(
						'extension/十周年UI/shoushaUI/character/images/longkuang/' + group + '.png'
					);
					...
					level.setBackgroundImage('extension/十周年UI/shoushaUI/character/images/level/' +
						leveltu.randomGet() + '.png');
					//新增技能框
					var wjkuang = ui.create.div('.wjkuang', dialog);

					wjkuang.setBackgroundImage(
						'extension/十周年UI/shoushaUI/character/images/jineng.png');
					//武将技能展示
					...
					//复用第二页面得随机名字
					var wanjiaming2 = ui.create.div('.wanjiaming2', dialog, player === game.me ? lib
						.config.connect_nickname : get.translation(innerText = num = ["氪金抽66",
							"卡宝真可爱", "蒸蒸日上", "√卡视我如父", "麒麟弓免疫枸杞", "坏可宣（老坏批）", "六千大败而归",
							"开局酒古锭", "遇事不决刷个乐", "见面两刀喜相逢", "改名出66", "时代的六万五", "韩旭", "司马长衫",
							"ogx",
							"狗卡不如无名杀", "王八万", "一拳兀突骨", "开局送神将", "丈八二桃", "装甲车车", "等我喝口酒",
							"Samuri", "马",
							"Log-Frunki", "aoe银钱豹", "没有丈八就托管", "无中yyds", "给咸鱼鸽鸽打call",
							"小零二哟～", "长歌最帅了",
							"大猫有侠者之风", "布灵布灵❤️", "我爱～摸鱼🐠～", "小寻寻真棒", "呲牙哥超爱笑", "是俺杀哒",
							"阿七阿七",
							"祖安·灰晖是龙王", "吃颗桃桃好遗计", "好可宣✓良民", "藏海表锅好", "金乎？木乎？水乎！！", "无法也无天",
							"西风不识相",
							"神秘喵酱", "星城在干嘛？", "子鱼今天摸鱼了吗？", "阳光苞里有阳光", "诗笺的小裙裙", "轮回中的消逝",
							"乱踢jb的云野",
							"小一是不是...是不是...", "美羊羊爱瑟瑟", "化梦的星辰", "杰哥带你登dua郎", "世中君子人",
							"叹年华未央", "短咕咕",
							"洛天依？！", "黄老板是好人～", "来点瑟瑟文和", "鲨鱼配辣椒", "萝卜～好萝卜", "废城君",
							"E佬细节鬼才",
							"感到棘手要怀念谁？", "半价小薯片", "JK欧拉欧拉欧拉", "新年快乐", "乔姐带你飞", "12345678？",
							"缘之空",
							"小小恐龙", "教主：杀我！", "才思泉涌的司马", "我是好人", "喜怒无常的大宝", "黄赌毒", "阴间杀～秋",
							"敢于劈瓜的关羽", "萌新陆逊", "猫猫虫", "芽衣姐，我不想死---", "暮暮子"
						].randomGet(1)));
					...
					if (judges.length) {
						...
						judges.forEach(function(card) {
							...
							if (cards?.length && (cards?.length !== 1 || cards[0].name !==
									card.name)) {
								if (!lib.card[card]?.blankCard || player.isUnderControl(
										true)) str += ('（' + get.translation(cards) + '）');
							}
							ui.create.div('.xskill', '<div data-color>' + str +
								'</div><div>' + get.translation(card.name + '_info') +
								'</div>', rightPane.firstChild);
						});
					}
